...
// The ctor.
MyLexerC::MyLexerC(QObject *parent, bool caseInsensitiveKeywords)
    : QsciLexer(parent),
...
const char *MyLexerC::language() const
{
    return "C";                                 //更改为C不影响功能
}
...
const char *MyLexerC::lexer() const
{
    return (nocase ? "cppnocase" : "cpp");      //不可更改为C否则其他控件可能无法识别
}


// Return the set of character sequences that can separate auto-completion
// words.
QStringList MyLexerC::autoCompletionWordSeparators() const
{
    QStringList wl;
...
const char *MyLexerC::blockStartKeyword(int *style) const
{
    if (style)
        *style = Keyword;
...
const char *MyLexerC::blockStart(int *style) const
{
    if (style)
        *style = Operator;
...
const char *MyLexerC::blockEnd(int *style) const
{
    if (style)
        *style = Operator;
...
const char *MyLexerC::wordCharacters() const
{
...
QColor MyLexerC::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool MyLexerC::defaultEolFill(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
QFont MyLexerC::defaultFont(int style) const
{
    QFont f;
...
const char *MyLexerC::keywords(int set) const
{
    if (set == 1)
        return
...
QString MyLexerC::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor MyLexerC::defaultPaper(int style) const
{
    switch (style)
    {
    case UnclosedString:
...
void MyLexerC::refreshProperties()
{
    setAtElseProp();
    setCommentProp();
    setCompactProp();
...
bool MyLexerC::readProperties(QSettings &qs,const QString &prefix)
{
...
bool MyLexerC::writeProperties(QSettings &qs,const QString &prefix) const
{
...
void MyLexerC::setFoldAtElse(bool fold)
{
    fold_atelse = fold;
...
void MyLexerC::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void MyLexerC::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void MyLexerC::setFoldPreprocessor(bool fold)
{
    fold_preproc = fold;
...
void MyLexerC::setStylePreprocessor(bool style)
{
    style_preproc = style;
...
void MyLexerC::setStylePreprocProp()
{
...
void MyLexerC::setDollarsAllowed(bool allowed)
{
    dollars = allowed;
...
void MyLexerC::setHighlightTripleQuotedStrings(bool enabled)
{
...
void MyLexerC::setHighlightTripleProp()
{
...
void MyLexerC::setHighlightHashQuotedStrings(bool enabled)
{
...
void MyLexerC::setHighlightHashProp()
{
...
void MyLexerC::setHighlightBackQuotedStrings(bool enabled)
{
...
void MyLexerC::setHighlightBackProp()
{
...
void MyLexerC::setHighlightEscapeSequences(bool enabled)
{
...
void MyLexerC::setHighlightEscapeProp()
{
...
void MyLexerC::setVerbatimStringEscapeSequencesAllowed(bool allowed)
{
    vs_escape = allowed;
...
void MyLexerC::setVerbatimStringEscapeProp()
{
